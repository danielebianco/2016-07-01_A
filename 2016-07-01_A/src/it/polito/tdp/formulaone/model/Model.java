...
public class Model {
	...
	public void creaGrafo(Season s) {
		...
		// l'istanza del grafo va creata qui e non nel costruttore perché
		// cambiando anno senza chiudere l'interfaccia il grafo si ingrossa
		// senza essere creato di nuovo, quindi --> pasticcio!!
